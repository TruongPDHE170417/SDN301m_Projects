...
productRouter.get('/', async (req, res, next) => {
    try {
        const result = await Products.find({}).populate('category').exec();
...
productRouter.get("/comments/:id", async (req, res, next) => {
    try {
...
productRouter.post('/comment/:id', async (req, res, next) => {
    let newComment;
    try {
...
productRouter.get("/images/:id", async (req, res, next) => {
    try {
